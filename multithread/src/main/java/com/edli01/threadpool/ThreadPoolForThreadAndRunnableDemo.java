package main.java.com.edli01.threadpool;

import main.java.com.edli01.TaiwanesePlaceThread;
...
*@Description: 
**/
public class ThreadPoolForThreadAndRunnableDemo {
...
//        threadPoolExample01(OVER_MAX_POOL_SIZE_AND_QUEUE_CAPACITY); // 會丟出異常
    ...
    private static void threadPoolExample01(int count) throws InterruptedException {
        System.out.println("****************Thread Pool開始(Thread/Runnable)(tasksIsWithinTheRange = " + count + ")****************");
        ...
        Runnable runnable = new TaiwanesePlaceThread();
        ...
        System.out.println("****************Thread Pool結束(Thread/Runnable)(tasksIsWithinTheRange = " + count + ")****************");
    }
